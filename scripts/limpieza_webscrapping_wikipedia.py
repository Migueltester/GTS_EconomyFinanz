...
# Agregar columnas estándar faltantes
df["unidad"] = "%"
df["codigo_indicador"] = "GOVT_DEBT_PCT_GDP"
df["codigo_region"] = df["pais"]  # si no tienes ISO alpha-3, usar nombre como código
df["fuente"] = "Wikipedia"
...
print("Deuda gobierno 2024 limpia y guardada en:\n", output_path)
